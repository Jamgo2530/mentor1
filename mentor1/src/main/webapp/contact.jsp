                  ...
                  <a href="index.html" class="nav-item nav-link">Home</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu text-capitalize">
                               <a href="reg/studentlogin.jsp" class="dropdown-item">Student</a>
                            <a href="reg/productlogin.jsp" class="dropdown-item">Mentor</a>
                             <a href="testimonial.html" class="dropdown-item">Admin/Dev</a>
                                                  </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 pb-5">
                    <div class="contact-form">
                        <div id="success"></div>
                        <form  method="post" action="newservlet" s >
